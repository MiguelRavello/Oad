...
int main(){
    ...
    a.push(-4);
    cout<<a<<endl;
    cout<<"La suma de los elementos de a: "<<a.sumarecursiva(a.head())<<endl;
    cout<<"El ultimo elemento de a: "<<a.toprec(a.head(),a.head()->m_next)->m_val<<endl;
    Celda b;
    b.push(5);
    b.push(6);
    b.push(7);
    ...
    c.remove(1);
    cout<<"\n"<<c<<endl;
    cout<<c.getValX(0)<<c.getValX(1)<<c.getValX(3)<<endl;
    c.insert(1,1);
    Celda d;
    d.push(8);
    d.push(7);
